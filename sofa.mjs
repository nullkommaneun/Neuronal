...
export class Sofa {
    ...
    init() {
        ...
        this.model.add(tf.layers.dense({
            units: 1,
            activation: 'tanh',
            // (3) STRATEGIE-ANPASSUNG: Ein Bias von -0.5 (statt -1.0) hilft dem Modell,
    ...
    async trainStep(corridor, lambdaCollision, lambdaArea) {
        ...
        // (1) KRITISCHE KORREKTUR: GPU/CPU Synchronisation.
        ...
        // Dies stellt sicher, dass der Optimierungsschritt abgeschlossen ist und die Gewichte aktualisiert sind.
        if (lossTensor) {
